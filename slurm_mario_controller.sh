...
#
# Smoke test first:
#   MARIO_CONTROLLER_RUN_TAG=nes-approach-v4-smoke NUM_ENVS=64 TARGET_ITERATIONS=5 \
#     ITERATIONS_PER_JOB=5 CHECKPOINT_INTERVAL=5 MAX_JOBS=1 \
#     ./slurm_mario_controller.sh
#
# Full training from scratch after the smoke test (new reward recipe):
#   MARIO_CONTROLLER_RUN_TAG=nes-approach-v4 ./slurm_mario_controller.sh
#
